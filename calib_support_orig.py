...
def loadCsv(temp):
    ...
    # Sélecection des fichiers CAL (avec la température)
    ...
    # rdm_brd = 611222992130
    # print("exceptionnelemnt ce brd sert de ref : ", rdm_brd)
...
def affichage(df, temp):
    ...
    if not os.path.exists('Graphiques_normal'):
        os.makedirs('Graphiques_normal')
    plt.savefig(r'Graphiques_normal\\'+str(temp)+'.png')
...
def generateModeleOpt():
    ...
    with open( r'pickle_normal.pkl', 'wb') as handle:
